...
interface ManualAdjustmentDeleteFormProps {
    adjustmentId: string;
    onActionComplete: () => void;
}

export function ManualAdjustmentDeleteForm({ adjustmentId, onActionComplete }: ManualAdjustmentDeleteFormProps) {
            ...
            <AlertDialogContent>
                <form onSubmit={handleSubmit}>
                    ...
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            Esta acción es irreversible. Se eliminará permanentemente este ajuste manual.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
