...
import { PropertyExpense, ExpenseCategory, Property, Provider } from "@/lib/data";
...
export default function ExpensesList({ expenses, categories, providers, onDataChanged, property }: ExpensesListProps) {
          ...
          <TableRow key={expense.id}>
            ...
            <TableCell className="text-right">
                <div className="flex items-center justify-end gap-2">
                    <ExpenseEditForm expense={expense} categories={categories} providers={providers} onExpenseUpdated={onDataChanged} propertyName={property.name} />
