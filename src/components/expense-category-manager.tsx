...
import { addExpenseCategory, updateExpenseCategory, deleteExpenseCategory, seedExpenseCategoriesAction } from '@/lib/actions';
        ...
        <AlertDialog>
            ...
            <AlertDialogContent>
                 <form onSubmit={handleSubmit}>
                    ...
                    <AlertDialogDescription>
                        {t('settings.categories.expenses_delete_confirm')}
                    </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
...
export default function ExpenseCategoryManager({ initialCategories, onCategoriesChanged }: { initialCategories: ExpenseCategory[], onCategoriesChanged: () => void }) {
  ...
  const handleLoadExamples = () => {
      ...
      startSeedTransition(async () => {
          const result = await seedExpenseCategoriesAction(orgId);
          if (result.success) {
